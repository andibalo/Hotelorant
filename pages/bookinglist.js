    ...
    return (
        <div>
            ...
            <Heading  color="brand.200" mb="5" fontSize="2xl" align="left">
                ...
                <Box pt="6"  color="#B0B0B0" w="1200px" alignItems="center" justifyContent="center" display="flex">
                    <Stack direction="row" spacing="5" mt="5" >
                    
                        <Box mr="10" h="250px" w="150px" position="left" overflow="hidden">
                            <Image borderRadius="10%" src="/register.png" layout="fill" objectFit="cover" />
                        </Box>
                        ...
                        <Box w="700px" h="200">
                            ...
                            <Text color="gray.300" fontSize="2l">
                                Jl. DR. Ide Anak Agung Gde Agung Jl. Mega Kuningan Barat No.1 Kuningan, Jakarta.
                            </Text>
